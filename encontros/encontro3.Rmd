...
plot(tabela_ec_freq_abs) # Gera um gráfico de linhas simples usando a função 'plot' para frequências absolutas.
plot(tabela_ec_freq_rel) # Gera um gráfico de linhas simples para frequências relativas.
plot(tabela_ec_freq_perc) # Gera um gráfico de linhas simples para percentuais.
...
pie(tabela_ec_freq_abs) # Gera um gráfico de setores para frequências absolutas.
pie(tabela_ec_freq_rel) # Gera um gráfico de setores para frequências relativas.
pie(tabela_ec_freq_perc) # Gera um gráfico de setores para percentuais.
...
barplot(tabela_sal_classes_abs, space = 0) # Gera um gráfico de barras sem espaço para as classes.
...
### 3.2.2. Boxplot
boxplot(dados$salario) # Gera um boxplot (diagrama de caixa) para a variável 'salario'.
