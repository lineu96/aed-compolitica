...
{\centering \includegraphics[width=0.6\linewidth]{./img/pc} 
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1795}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1410}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1026}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1154}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0769}}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2821}}@{}}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2973}}@{}}
\caption{Tabela de frequências para o grau de instrução.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
Instrução
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1127}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1690}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1690}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2394}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.3099}}@{}}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1184}}
